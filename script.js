document.addEventListener('DOMContentLoaded', function () {
    ...
    const lyrics = [
        ...
        { time: 8.7, text: "Un kannadiyil naan, ennai thedi ponene," },
        { time: 9.3, text: "Kannodu kannin vishayam theriyuma?" },
        { time: 14, text: "Un mazhaiyil naan, kaatrai thedi nadandhen," },
        { time: 17.5, text: "Kattrin oram, kadhalin moham." },
        { time: 18, text: "Hey, raathiri raathiri radhai," },
        { time: 19.5, text: "Enakku ipo venum bodhai." },
        { time: 20.5, text: "Takkaru takkaru damaaru," },
        { time: 29, text: "Nee illama naanum sumaaru." },
