document.addEventListener('DOMContentLoaded', function () {
    ...
    const lyrics = [
        ...
        { time: 11, text: "Un kannadiyil naan, ennai thedi ponene," },
        { time: 14, text: "Kannodu kannin vishayam theriyuma?" },
        { time: 18, text: "Un mazhaiyil naan, kaatrai thedi nadandhen," },
        { time: 23, text: "Kattrin oram, kadhalin moham." },
        { time: 33, text: "Hey, raathiri raathiri radhai," },
        { time: 38, text: "Enakku ipo venum bodhai." },
        { time: 43, text: "Takkaru takkaru damaaru," },
        { time: 48, text: "Nee illama naanum sumaaru." },
