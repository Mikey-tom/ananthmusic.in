document.addEventListener('DOMContentLoaded', function () {
    ...
    const lyrics = [
        ...
        { time: 13.5, text: "Kannodu kannin vishayam theriyuma?" },
        { time: 17.9, text: "Un mazhaiyil naan, kaatrai thedi nadandhen," },
        { time: 18.5, text: "Kattrin oram, kadhalin moham." },
        { time: 21, text: "Hey, raathiri raathiri radhai," },
        { time: 25, text: "Enakku ipo venum bodhai." },
        { time: 29.5, text: "Takkaru takkaru damaaru," },
        { time: 32, text: "Nee illama naanum sumaaru." },
        { time: 35.5, text: "Oru vaarthai sol, naan vaazhven," },
