document.addEventListener('DOMContentLoaded', function () {
    ...
    const lyrics = [
        ...
        { time: 8.1, text: "Un kannadiyil naan, ennai thedi ponene," },
        { time: 8.95, text: "Kannodu kannin vishayam theriyuma?" },
        { time: 11, text: "Un mazhaiyil naan, kaatrai thedi nadandhen," },
        { time: 13, text: "Kattrin oram, kadhalin moham." },
