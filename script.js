document.addEventListener('DOMContentLoaded', function () {
    ...
    const lyrics = [
        ...
        { time: 1, text: "Pesi pesi sudukadu aacho." },
        { time: 1.25, text: "Cat-u talk-u, moon walk-u," },
        { time: 1.50, text: "Avala paathu ellam poocho." },
        { time: 2, text: "Un kannadiyil naan, ennai thedi ponene," },
        { time: 2.25, text: "Kannodu kannin vishayam theriyuma?" },
        { time: 2.50, text: "Un mazhaiyil naan, kaatrai thedi nadandhen," },
        { time: 3, text: "Kattrin oram, kadhalin moham." },
