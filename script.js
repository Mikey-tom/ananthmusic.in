document.addEventListener('DOMContentLoaded', function () {
    ...
    const lyrics = [
        ...
        { time: 4.5, text: "Avala paathu ellam poocho." },
        { time: 5, text: "Un kannadiyil naan, ennai thedi ponene," },
        { time: 9, text: "Kannodu kannin vishayam theriyuma?" },
        { time: 13, text: "Un mazhaiyil naan, kaatrai thedi nadandhen," },
        { time: 15, text: "Kattrin oram, kadhalin moham." },
        { time: 19, text: "Hey, raathiri raathiri radhai," },
        { time: 22, text: "Enakku ipo venum bodhai." },
        { time: 24, text: "Takkaru takkaru damaaru," },
        { time: 28, text: "Nee illama naanum sumaaru." },
        { time: 32, text: "Oru vaarthai sol, naan vaazhven," },
